...
public abstract class Utilities implements Constants {
     ...
     * 把实数转换为字符串。精度为1E-9
     */
    public static String realToString(double a) {
        String s = String.format("%.9G", a);
        if (!s.contains(".")) {
            return s;
        }
     ...
     * 字符串转换为double
     */
    public static double str2d(String s) {
       if (s.isEmpty())
          return 0;
    ...
    public static void main(String[] args) throws IOException {
        System.out.println(realToString(1.23456));
        System.out.println(realToString(12));
        System.out.println(realToString(12.3));
        System.out.println(realToString(12.3e11));
        System.out.println(realToString(12.345e11));
        System.out.println(realToString(12e11));
        System.out.println(realToString(2e11));
